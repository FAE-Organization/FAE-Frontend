...
export default function DirectoryGrid({ cards, counts }) {
        ...
        <Stack width='100%' alignItems='center'>
            ...
            >
                ...
                {cards.map((card, index) => {
                    let currentCardTitle = card.title.replace(/[^\w\s]|_/g, "").replace(/\s+/g, " ").toLowerCase();
                    const currentCardMetadata = counts[currentCardTitle]
                                    ...
                                    >
                                        <Stack zIndex={1}>
                                            <Badge
                                                ...
                                                borderRadius='5px'
                                            >
                                                {currentCardMetadata.count - (currentCardMetadata.count % 10) + '+'} profiles
                                            </Badge>
                                        </Stack>
                                        <Stack
                                            zIndex={1}
